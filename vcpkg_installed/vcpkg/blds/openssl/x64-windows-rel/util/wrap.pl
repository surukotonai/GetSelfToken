...
BEGIN {
    ...
    require 'C:/Users/aaaa/source/repos/OPGRABBERS/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'C:/Users/aaaa/source/repos/OPGRABBERS/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = 'C:/Users/aaaa/source/repos/OPGRABBERS/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/test/default-and-jitter.cnf';
    shift;
